...
class _FeedScreenState extends State<FeedScreen> {
  ...
  initList() async {
    ...
    loadDataStream = (global == "true"
            ...
            : FirebaseFirestore.instance.collection('posts').where("country", isEqualTo: countryCode))
      ...
      for (var change in event.docChanges) {
        switch (change.type) {
          ...
          case DocumentChangeType.modified:
            updatingStream
                .add(Post.fromMap({...change.doc.data()!})); // we are sending a modified object in the stream.
            break;
          case DocumentChangeType.removed:
            postsList
                .remove(Post.fromMap({...change.doc.data()!})); // we are removing a Post object from the local list.
            break;
        }
      }
      setState(() {});
  ...
  initPollList() async {
    ...
    loadDataStreamPoll = (global == "true"
            ...
            : FirebaseFirestore.instance.collection('polls').where("country", isEqualTo: countryCode))
        .where("global", isEqualTo: global)
      ...
      for (var change in event.docChanges) {
        switch (change.type) {
          ...
          case DocumentChangeType.modified:
            updatingStreamPoll
                .add(Poll.fromMap({...change.doc.data()!})); // we are sending a modified object in the stream.
            break;
          case DocumentChangeType.removed:
            pollsList
                .remove(Poll.fromMap({...change.doc.data()!})); // we are removing a Post object from the local list.
            break;
        }
      }
      setState(() {});
                                    ...
                                    ? Column(
                                        children: [
                                          ...
                                          AnimatedToggleSwitch<String>.rollingByHeight(
                                              ...
                                              innerColor: const Color.fromARGB(255, 228, 228, 228),
                                              indicatorColor: const Color.fromARGB(255, 157, 157, 157),
                                              borderColor: const Color.fromARGB(255, 135, 135, 135),
                                              iconOpacity: 1),
                                        ],
                                      )
                                    : Column(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: user?.photoUrl != null
                                              ...
                                              : const DecorationImage(
                                                  image: AssetImage('assets/avatarFT.jpg'),
                                                  fit: BoxFit.cover,
                                                ),
                                        ),
                                      ),
                                          ...
                                          children: [
                                            user?.profileFlag == "true"
                                                ? SizedBox(
                                                    width: 19,
                                                    height: 9.5,
                                                    child: Image.asset('icons/flags/png/${user?.country}.png',
                                                        package: 'country_icons'))
                                                : Row()
                                          ],
                                        ),
                                            ...
                                            user?.profileBadge == "true"
                                                ? const CircleAvatar(
                                                    ...
                                                    child: Icon(Icons.verified,
                                                        color: Color.fromARGB(255, 113, 191, 255), size: 15),
                                                  )
                                                : Row()
                                          ],
                                        ),
              ...
              postsList.isNotEmpty && messages == "true"
                  ...
                  : postsList.isEmpty && messages == "true" && global == "true"
                      ? const Center(
                          child: Text(
                            'No messages yet.',
                            style: TextStyle(color: Color.fromARGB(255, 114, 114, 114), fontSize: 18),
                          ),
                        )
                      : postsList.isEmpty && messages == "true" && global == "false"
                          ? Center(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      width: 24,
                                      height: 16,
                                      child: Image.asset('icons/flags/png/$countryCode.png', package: 'country_icons'),
                                    ),
                                  ),
                                  const Text(
                                    'messages yet.',
                          ...
                          : pollsList.isNotEmpty && messages == "false"
                              ...
                              : pollsList.isEmpty && messages == "false" && global == "true"
                                  ? const Center(
                                      child: Text(
                                        'No polls yet.',
                                        style: TextStyle(color: Color.fromARGB(255, 114, 114, 114), fontSize: 18),
  ...
  Widget rollingIconBuilderStringTwo(String messages, Size iconSize, bool foreground) {
  ...
  Widget rollingIconBuilderStringThree(String global, Size iconSize, bool foreground) {
